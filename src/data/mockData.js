...
// Verified legal counsel network for the Attorney Network directory.
export const attorneyNetwork = [
  {
    id: 'at1',
    ...
    role: 'Senior Counsel',
    location: 'New York',
    specialties: ['Immigration Law', 'Fleet Compliance'],
    status: 'available',
    activeCases: 14,
    successRate: 98.2,
    contactBadge: 'Fleet Compliance Point of Contact',
    email: 'm.sterling@aetheric.com',
    phone: '+1 (555) 018-2231',
    barLicenseNumber: 'NY-441207',
    licenseStatus: 'valid',
    licensedIn: ['NY', 'CA', 'MA'],
    multiStateCertified: true,
    caseVolume: { total: 860, general: 620, internal: 240 },
    winRate: 98.2,
    officeLocation: ['112 Wall Street, Suite 2200', 'New York, NY 10005'],
    languages: ['English'],
    detailSpecialties: [
      { icon: 'shield', label: 'Immigration Law' },
      { icon: 'truck', label: 'Fleet Compliance' },
      { icon: 'briefcase', label: 'Regulatory Affairs' },
    ],
    bio: [
      'Marcus Sterling is a senior counsel with over 15 years of experience advising enterprise fleet operators on cross-border compliance and immigration matters.',
      'He has represented Fortune 500 logistics companies before federal regulators and built the compliance playbooks now used across the ASMAN network.',
    ],
  },
  {
    id: 'at2',
    ...
    location: 'Miami',
    specialties: ['Civil Defense', 'Liability'],
    status: 'active',
    activeCases: 8,
    successRate: 96.5,
  ...
  },
  {
    ...
    location: 'Chicago',
    specialties: ['Compliance', 'Federal Regulations'],
    status: 'available',
    activeCases: 3,
    successRate: 100,
    contactBadge: 'Regulatory Affairs Lead',
    email: 'j.chen@aetheric.com',
    phone: '+1 (555) 044-7712',
    barLicenseNumber: 'IL-220981',
    licenseStatus: 'valid',
    licensedIn: ['IL', 'WI'],
    multiStateCertified: true,
    caseVolume: { total: 340, general: 210, internal: 130 },
    winRate: 100,
    officeLocation: ['200 W Monroe St, Suite 900', 'Chicago, IL 60606'],
    ...
    bio: [
      'Julian Chen focuses on federal regulatory compliance for interstate fleet operations, with a perfect track record across three years of active caseload.',
      'He regularly advises on DOT and FMCSA policy changes, helping the ASMAN network stay ahead of emerging federal requirements.',
    ],
  },
  {
    id: 'at4',
    ...
    rating: 4.7,
    reviews: 156,
    role: 'Global Logistics Partner',
    location: 'London',
    specialties: ['International Fleet', 'Safety Audit'],
    status: 'on_leave',
    activeCases: 0,
    successRate: 94.8,
    ...
    caseVolume: { total: 980, general: 700, internal: 280 },
    winRate: 94.8,
    ...
    bio: [
      ...
      'She is currently on leave; her caseload is being covered by the regional compliance team.',
    ],
  },
  {
    id: 'at5',
    ...
    rating: 4.9,
    reviews: 310,
    role: 'Constitutional Law',
    location: 'DC',
    specialties: ['Immigration Policy', 'Advocacy'],
    status: 'available',
    activeCases: 22,
    successRate: 99.1,
    contactBadge: 'Constitutional Policy Advisor',
    email: 'a.vance@aetheric.com',
    phone: '+1 (555) 090-3312',
    barLicenseNumber: 'DC-330187',
    licenseStatus: 'valid',
    licensedIn: ['DC', 'VA', 'MD'],
    multiStateCertified: true,
    caseVolume: { total: 1560, general: 1100, internal: 460 },
    winRate: 99.1,
    officeLocation: ['1200 K Street NW, Suite 800', 'Washington, DC 20005'],
    languages: ['English'],
    detailSpecialties: [
      { icon: 'shield', label: 'Immigration Policy' },
      { icon: 'briefcase', label: 'Constitutional Advocacy' },
      { icon: 'file', label: 'Federal Litigation' },
    ],
    bio: [
      'Dr. Alistair Vance is a constitutional law scholar and advocate with over 300 successful engagements on immigration policy and federal litigation.',
      'He advises the ASMAN network on the constitutional dimensions of enterprise safety and detention response protocols.',
    ],
  },
  {
    id: 'at6',
    ...
    rating: 4.85,
    reviews: 140,
    role: 'International Trade Counsel',
    location: 'Boston',
    specialties: ['Trade Compliance', 'Customs Law'],
    status: 'available',
    activeCases: 10,
    successRate: 97.3,
    contactBadge: 'Trade Compliance Point of Contact',
    email: 'n.clarke@aetheric.com',
    phone: '+1 (555) 077-4429',
    barLicenseNumber: 'MA-556320',
    licenseStatus: 'valid',
    licensedIn: ['MA', 'NY'],
    multiStateCertified: true,
    caseVolume: { total: 610, general: 430, internal: 180 },
    winRate: 97.3,
    officeLocation: ['1 Federal Street, Suite 1900', 'Boston, MA 02110'],
    languages: ['English'],
    detailSpecialties: [
      { icon: 'box', label: 'Trade Compliance' },
      { icon: 'file', label: 'Customs Law' },
      { icon: 'briefcase', label: 'Import/Export Policy' },
    ],
    bio: [
      'Naomi Clarke advises on international trade compliance and customs law for cross-border freight operations.',
      'She works closely with fleet operations teams to keep shipments aligned with evolving trade regulations.',
    ],
  },
]
...
// Attorney Network Administration roster for the Super Admin Case Tracker page.
